...
export type DaoParams = {
  ...
  tokenName: string;
  tokenSymbol: string;
  ContributionReward: SchemeConfig;
  GenericScheme: SchemeConfig;
  SchemeRegistrar: SchemeConfig;
  GlobalConstraintRegistrar: SchemeConfig;
  UpgradeScheme: SchemeConfig;
  VotingMachinesParams: VotingMachineConfig[];
  schemes: SchemeList;
